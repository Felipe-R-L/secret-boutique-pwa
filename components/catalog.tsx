...
export function Catalog() {
  ...
  return (
    <>
      ...
      {/* Catalog Section */}
      <section id="catalog" className="mx-auto max-w-7xl px-4 py-12 md:px-6 md:py-16 lg:py-20">
        <div className="mb-8 space-y-4 md:mb-12">
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-end md:justify-between">
            <div className="space-y-2">
              ...
              <p className="max-w-md text-muted-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>
                Explore nossa colecao cuidadosamente selecionada de produtos premium.
              </p>
            </div>
