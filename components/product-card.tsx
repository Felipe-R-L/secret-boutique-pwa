  ...
  return (
    ...
    >
      <div className="relative aspect-4/5 overflow-hidden bg-muted">
        ...
        {/* Overlay gradient */}
        <div className="absolute inset-0 bg-linear-to-t from-foreground/30 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
      ...
      <div className="p-4 lg:p-5">
        ...
        {/* Product name */}
        <h3
          className="line-clamp-2 text-sm font-medium leading-snug text-foreground transition-colors group-hover:text-foreground/80 lg:text-base"
