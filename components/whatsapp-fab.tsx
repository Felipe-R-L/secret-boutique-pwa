...
export function WhatsappFab() {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-[#25D366] opacity-60 transition-transform duration-1000 group-hover:scale-125 motion-safe:animate-ping" />
    </a>
  );
}
