...
export function ProductDrawer({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange} direction='bottom'>
      <DrawerContent className='h-[90vh] max-h-[90vh] rounded-t-3xl px-0 pb-0'>
        <div className='flex h-full flex-col'>
          <div className='flex-1 overflow-y-auto'>
            ...
            <div className='space-y-2 bg-muted/40 p-3'>
              ...
              >
                <DrawerClose asChild>
                  <button
                    type='button'
                    className='absolute right-4 top-4 z-20 inline-flex size-10 items-center justify-center rounded-full border border-white/70 bg-white/85 text-foreground shadow-sm backdrop-blur-sm transition hover:bg-white'
            ...
            <div className='space-y-5 px-5 py-6'>
              ...
              <DrawerHeader className='space-y-2 px-0 text-left'>
                <DrawerTitle className='font-sans text-2xl font-semibold leading-tight text-foreground'>
                  {product.name}
                </DrawerTitle>
          ...
          {/* Footer */}
          <DrawerFooter className='flex-row items-center gap-4 border-t border-border bg-background px-5 py-4'>
